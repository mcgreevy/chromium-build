...
def Update(c):
  ...
  specs = [
    ...
    {'name': 'Android32 x86 Debug', 'subordinatebuilddir': 'android_x86'},
    {'name': 'Android64 x64 Debug', 'subordinatebuilddir': 'android_x64'},
    {'name': 'Android32 MIPS Debug', 'subordinatebuilddir': 'android_mips'},
    {
      'name': 'Android Tester ARM32 Debug (Nexus 5X)',
      'subordinatebuilddir': 'android_arm32',
    },
    {
