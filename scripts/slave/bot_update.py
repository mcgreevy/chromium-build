...
def parse_args():
  ...
  parse.add_option('--main',
                   help='Main name. If specified and it is not in '
...
def main():
  ...
  if not main:
    # bot_update activation whitelist is checked only on buildbot mains.
    # If there is no main, bot_update is always active.
    options.force = True

  # Check if this script should activate or not.
  active = options.force or check_valid_host(main, builder, subordinate)
